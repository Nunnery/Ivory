package mkremins.fanciful.v_1_7_R3;
...
public final class FancyMessage implements IFancyMessage {
    ...
    public IFancyMessage achievementTooltip(final Achievement which) {
        net.minecraft.server.v1_7_R3.Achievement nms = CraftStatistic.getNMSAchievement(which);
    ...
    public IFancyMessage statisticTooltip(final Statistic which) {
        ...
        net.minecraft.server.v1_7_R3.Statistic nms = CraftStatistic.getNMSStatistic(which);
        return achievementTooltip(nms.name);
    }
    ...
    public IFancyMessage statisticTooltip(final Statistic which, Material item) {
        ...
        net.minecraft.server.v1_7_R3.Statistic nms = CraftStatistic.getMaterialStatistic(which, item);
        return achievementTooltip(nms.name);
    }
    ...
    public IFancyMessage statisticTooltip(final Statistic which, EntityType entity) {
        ...
        net.minecraft.server.v1_7_R3.Statistic nms = CraftStatistic.getEntityStatistic(which, entity);
        return achievementTooltip(nms.name);
    }
