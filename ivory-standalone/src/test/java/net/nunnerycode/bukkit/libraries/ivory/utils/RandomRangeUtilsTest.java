...
public class RandomRangeUtilsTest {
  ...
  public void testRandomDoubleFromDoubleRangeExclusiveOne() throws Exception {
    ...
    double
        result =
        RandomRangeUtils.randomDoubleFromDoubleRangeExclusive(new DoubleRange(min, max));
  ...
  public void testRandomDoubleFromDoubleRangeInclusiveOne() throws Exception {
    ...
    double
        result =
        RandomRangeUtils.randomDoubleFromDoubleRangeInclusive(new DoubleRange(min, max));
