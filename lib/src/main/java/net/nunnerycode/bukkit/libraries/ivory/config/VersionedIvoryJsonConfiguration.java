...
public class VersionedIvoryJsonConfiguration extends IvoryJsonConfiguration
  ...
  /**
   * Instantiates a new VersionedIvoryJsonConfiguration with a selected {@link java.io.File} to
   * load/save from/to, a {@link java.io.File} to check against, and an {@link
   * net.nunnerycode.bukkit.libraries.ivory.config.VersionedIvoryJsonConfiguration.VersionUpdateType}.
   *
