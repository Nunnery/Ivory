...
public final class CurseForgeQuery {
  ...
  /**
   * Returns a {@link net.nunnerycode.bukkit.libraries.ivory.query.CurseForgeQuery.BukkitProject}
   * with the given name from BukkitDev.
   *
  ...
  /**
   * A simple class to hold data about a project on BukkitDev. </p> Creating a new BukkitProject
   * will not create a new project on BukkitDev.
   */
